...
public class MainActivityTest {
    ...
    public static class HomeTest {
        ...
        public void testadd(){
            ...
            onView(withId(R.id.addHeartRate)).perform(androidx.test.espresso.action.ViewActions.typeText("75"));
            pressBack();
        ...
        public void testedit(){
            ...
            onView(withId(R.id.updateHeartRate)).perform(ViewActions.clearText(),ViewActions.typeText("80"));
            onView(withId(R.id.updateDate)).perform(ViewActions.clearText(), ViewActions.typeText("23-07-2022"));
            onView(withId(R.id.updateSystolic)).perform(ViewActions.clearText(), ViewActions.typeText("75"));
            onView(withId(R.id.updateSystolic)).perform(ViewActions.clearText(), ViewActions.typeText("100"));
            pressBack();
